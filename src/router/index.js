...
const routes = [
  ...
  },
  {
    path: '/me/searches',
    name: 'SavedSearches',
    component: () => import('@/views/SavedSearches.vue'),
    meta: { requiresAuth: true }
  },
  {
    path: '/login/magic-token/:token',
    name: 'Magic-token',
    component: () => import('../components/user/UserMagicToken.vue'),
  },
  {
    path: '/me',
    name: 'Me',
  ...
  {
    path: '/stats',
    component: () => import('@/views/OurStats.vue'),
  },
