...
const routes = [
    ...
    {path: '/pricing-new', redirect: '/pricing-new/institutions'},
    {path: '/pricing-new/developers', name: 'PricingNewDevelopers', component: PricingPageNew, props: {initialContext: 'developers'}},
    {path: '/pricing-new/institutions', name: 'PricingNewInstitutions', component: PricingPageNew, props: {initialContext: 'institutions'}},
    {path: '/pricing', redirect: '/pricing-new/institutions'},
    {path: '/pricing/institutions', redirect: '/pricing-new/institutions'},
    {path: '/pricing/developers', redirect: '/pricing-new/developers'},
