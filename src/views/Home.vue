...
const faqs = computed(() => [
  ...
  },
  {
    ...
    answer: 'Explore our web interface to search and browse the data. Check out the <a href="https://developers.openalex.org/" target="_blank">API documentation</a> to start building. Or <a href="https://help.openalex.org/access/snapshot/" target="_blank">download a snapshot</a> of the full dataset. All free, no signup required.'
  }
]);
