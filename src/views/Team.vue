<template>
  <static-page title="Team" :sections="sections">
    <template #intro>
      We're a small team with a big vision.
    </template>

    <static-section id="staff" title="Staff">
      <p class="section-body">Our paid full-time and contract staff handle day-to-day operations.</p>
    ...
    <static-section id="board" title="Board of Directors">
      <p class="section-body">Our volunteer board of directors governs our company.</p>
      <div class="d-flex flex-wrap">
        <person-card
    ...
    <static-section id="advisory-board" title="Advisory Board">
      <p class="section-body">
        Our volunteer advisory board represents our community.
        <a href="https://docs.google.com/document/d/1TVEsfqRLAcNpiZkvFuKoGKVo6FVNwisRsThnz78kgI4/edit?tab=t.0#heading=h.mbrwjopt6w77">Learn more here</a>.
      </p>
      <div class="d-flex flex-wrap">
        <person-card
