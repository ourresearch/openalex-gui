...
/* hover block-highlight: an extra-subtle band spanning the full canvas (Jason 2026-06-17:
   ...
   coloured now. Round 3 tried highlighter yellow (a third hue); round 4 lightened it;
   round 5 (Jason): the yellow "interacts strangely" with the two families - bands are
   LIGHT PEACH instead (hover+famhov = V1's faded-connector peach #fdf6f0; selected the
   same hue a step toward the chip peach). One hue, two strengths, as always. */
