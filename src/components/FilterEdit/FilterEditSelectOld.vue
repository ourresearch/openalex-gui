...
<!--        </v-btn>-->
      ...
      <v-card-text :style="{height: dialogTextHeight}" class="pa-0 overflow-y-auto">
        ...
        <div class="jason-foo">
          <v-autocomplete
              :menu-props="{'content-class': 'jason-test', 'max-width': 200, 'attach': '.jason-foo'}"
...
export default {
  ...
  computed: {
    ...
    optionIds(){
      return url.readFilterValue(this.entityType, this.filterKey).split(/[|+]/)
    }
  },
