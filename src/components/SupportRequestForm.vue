<template>
  <!-- The support-request form (oxjob #751/#823), shared by the /support page
       and the New-request dialog on settings/tickets. Everything but the page
       chrome lives here so the two surfaces can't drift. -->
  <div>
    <!-- Filed -->
...
defineOptions({ name: 'SupportRequestForm' });
...
// Shared with every surface this form appears on, so a draft started on
// /support survives into the settings dialog and vice versa.
