...
const oaxConfigs = {
    "authors": {
        ...
        "showOnTablePage": ["display_name", "publication_year", "type", "primary_location.source.id", "authorships.author.id", "authorships.institutions.id", "primary_topic.id", "open_access.oa_status", "cited_by_count"],
