...
const entityConfigs = {
    ...
    subfields: {
        ...
        exportColumns: [
            ...
            { key: "field.display_name", label: "Field" },
            { key: "domain.display_name", label: "Domain" },
    ...
    countries: {
        ...
        exportColumns: [
            { key: "id", label: "ID" },
            { key: "display_name", label: "Name" },
            { key: "continent.display_name", label: "Continent" },
            { key: "is_global_south", label: "Global South" },
            { key: "works_count", label: "Works Count" },
            { key: "cited_by_count", label: "Cited By Count" },
        ],
    ...
    "indexes": {
        ...
        category: "publishing",
        descr: "Bibliographic indexes that list works: Crossref, PubMed, DataCite, DOAJ, arXiv",
        eg: "DOAJ",
        placeholder: "Search indexes",
        filterName: "indexed in",
        filterKey: "indexed_in",
        hasAutocomplete: false,
        isNative: false,
        rowsToShowOnEntityPage: [
            "description",
