...
const entityConfigs = {
    ...
    subfields: {
        ...
        exportColumns: [
            ...
            { key: "description", collection: "Description" },
            { key: "field.display_name", collection: "Field" },
            { key: "domain.display_name", collection: "Domain" },
            { key: "works_count", collection: "Works Count" },
            { key: "cited_by_count", collection: "Cited By Count" },
        ],
        category: "topics",
        descr: "Mid-level academic disciplines (~250 entries) grouping related topics",
    ...
    fields: {
        ...
        category: "topics",
        descr: "Broad academic disciplines (~25) like Biology, Chemistry, Physics",
        eg: "Computer science",
    ...
    domains: {
        ...
        category: "topics",
        descr: "Four top-level research areas: Life Sciences, Physical Sciences, Health Sciences, Social Sciences",
        eg: "Life sciences",
    ...
    sdgs: {
        ...
        category: "topics",
        descr: "United Nations Sustainable Development Goals linked to research",
    ...
    countries: {
        ...
        exportColumns: [
            { key: "id", collection: "ID" },
            { key: "display_name", collection: "Name" },
            { key: "continent.display_name", collection: "Continent" },
            { key: "is_global_south", collection: "Global South" },
            { key: "works_count", collection: "Works Count" },
            { key: "cited_by_count", collection: "Cited By Count" },
        ],
        category: "geo-language",
        descr: "Countries where research-affiliated institutions are located",
        eg: "Nigeria",
    ...
    continents: {
        ...
        category: "geo-language",
        descr: "Continental regions for geographic analysis of research",
        eg: "Africa",
    ...
    languages: {
        ...
        category: "geo-language",
        descr: "Languages in which scholarly works are written",
        eg: "Swahili",
    ...
    types: {
        ...
        category: "research-output",
        descr: "Formats of scholarly output: articles, books, datasets, preprints, etc.",
        eg: "article",
    ...
    "source-types": {
        ...
        category: "publishing",
        descr: "Categories of publication venues: journals, repositories, conferences",
        eg: "journal",
    ...
    "institution-types": {
        ...
        category: "people-orgs",
        descr: "Categories of organizations: universities, companies, hospitals, governments",
        eg: "company",
    ...
    "licenses": {
        ...
        descr: "Open Access licenses like CC-BY, CC-BY-SA, and others",
        eg: "CC-BY",
    ...
    "oa-statuses": {
        ...
        category: "open-access",
        descr: "Open Access classifications: gold, green, hybrid, bronze, closed",
        eg: "gold",
...
const entityCategories = [
    ...
    { id: 'people-orgs', name: 'People & organizations' },
