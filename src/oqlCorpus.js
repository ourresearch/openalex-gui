...
export const oqlCorpus = [
  ...
  },
  {
    ...
    "note": "A 2+ value list is parenthesized and joined by `or`/`and`: `type is (article or review)` is an OR-group of equality leaves.",
    "diagnostic": "",
    "oqo": {
      "get_rows": "works",
      "filter_rows": [
  ...
  },
  {
    ...
    "provenance": {
      "type": "spec design",
      "label": "OQL parens-bag (#363): items use or/and, not commas",
      "url": null
    },
    "oxurl_status": null,
    "status": "error",
    "oql": "works where type is (article, review)",
    "note": "A (…) group joins items with `or`/`and`, not commas. Fix: `type is (article or review)`.",
  ...
  },
  {
    ...
    "oxurl_status": "has-oxurl",
    "status": "ok",
    "oql": "funders where works count > (1000)",
    "note": "#406 Part B fallback field. Since #573 (strict GUI==OQL parity) `works_count` is GUI-filter-faceted on EVERY entity that has it, so the `_faceted_everywhere` render gate passes and it renders the friendly 'works count' (pre-#573 it rendered the raw column_id).",
    "diagnostic": "",
    "oqo": {
      "get_rows": "funders",
      "filter_rows": [
